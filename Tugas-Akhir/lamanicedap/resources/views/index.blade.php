      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{URL::to('daftarlahir')}}"><i class="fa fa-circle-o"></i> Daftar Lahir</a></li>
            <li><a href="{{URL::to('monitoringlahir')}}"><i class="fa fa-circle-o"></i> Monitoring</a></li>
            <li><a href="{{URL::to('bantuanlahir')}}"><i class="fa fa-circle-o"></i> Bantuan</a></li>
            <li><a href="{{URL::to('daftarrs')}}"><i class="fa fa-circle-o"></i> Daftar Rumah Sakit</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Daftar Mati</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Upload Mati</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Monitoring</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Bantuan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Daftar Pindah</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Upload Pindah</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Monitoring</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Bantuan</a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Daftar Datang</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Upload Datang</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Monitoring</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Bantuan</a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Daftar Nikah</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Upload Nikah</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Monitoring</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Bantuan</a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Daftar Cerai</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Upload Cerai</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Monitoring</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Bantuan</a></li>
          </ul>
        </li>
