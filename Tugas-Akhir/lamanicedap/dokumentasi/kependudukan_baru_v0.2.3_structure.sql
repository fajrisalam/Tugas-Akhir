...
CREATE TABLE `data_kelahiran_pus` (
  `NO_KET_PUS` varchar(22) NOT NULL,
  ...
  `BERAT_ANAK` int(5) DEFAULT NULL,
  `PANJANG_ANAK` int(3) DEFAULT NULL,
...
/* Procedure structure for procedure `sp_setAktaNum` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_setAktaNum` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`139.194.163.180` PROCEDURE `sp_setAktaNum`(sNO_KET_RSPUS VARCHAR(22), sJNS_SURAKTA TINYINT(2))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`139.194.163.180` PROCEDURE `sp_setRSPusRegNum`(sNO_IDNT BIGINT(10),  
